  ...
  useEffect(() => {
    ...
    function createCodepen(cameraJsCode: object) {
      ...
      var jt = beautify.js_beautify(
        jsTemplate.replace("[CAMERAHERE]", JSON.stringify(cameraJsCode)),
      ...
      var data = {
        ...
        css_external:
          "https://js.arcgis.com/4.15/esri/css/main.css;https://s3-us-west-1.amazonaws.com/patterns.esri.com/files/calcite-web/1.0.2/css/calcite-web.min.css"
      };
